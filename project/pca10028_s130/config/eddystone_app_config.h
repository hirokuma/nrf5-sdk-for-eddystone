...
#define USE_ECB_ENCRYPT_HW                              0                                /**< Configure between using the hardware peripheral or software library for ECB encyrption (decryption is always SW) */
...
//BLE CONFIGS
#define APP_DEVICE_NAME                                 "nRF51-Eddy"
